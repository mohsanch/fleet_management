...
@section('breadcrumbs', 'Admin / Branches / Create')
@section('page_title', 'Create Branch')

@section('content')
<div class="card" style="max-width: 600px; margin: 0 auto; padding: 24px;">
    <h3 style="margin-top: 0; margin-bottom: 20px; color: var(--text-color);">Add New Branch</h3>
    ...
    <form action="{{ route('admin.branches.store') }}" method="POST">
        ...
        <div style="margin-bottom: 16px;">
            ...
            <input type="text" name="name" class="form-input" required value="{{ old('name') }}" placeholder="e.g. Sahiwal Branch" style="width: 100%;">
            @error('name')
        ...
        <div style="margin-bottom: 16px;">
            ...
            <input type="text" name="code" class="form-input" required value="{{ old('code') }}" placeholder="e.g. SWL" style="width: 100%;">
            @error('code')
                <span style="color: #E53E3E; font-size: 12px; display: block; margin-top: 5px;">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div style="display: flex; gap: 12px; justify-content: flex-end;">
            ...
            <button type="submit" class="btn-signin">Save Branch</button>
        </div>
    </form>
</div>
@endsection
